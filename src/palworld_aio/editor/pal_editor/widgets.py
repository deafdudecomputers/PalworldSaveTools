import math
from PySide6.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QFrame, QWidget, QLayout
from PySide6.QtCore import Qt, QTimer, QEvent, QPoint, QPointF, QRectF, QRect, QSize, Signal
