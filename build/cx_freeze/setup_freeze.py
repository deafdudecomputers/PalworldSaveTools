...
setup(name='PalworldSaveTools', version="2.3.3", options={'build_exe': build_exe_options}, executables=[Executable('src/palworld_aio/main.py', base='gui', target_name='PalworldSaveTools.exe', icon='resources/assets/icons/app/icon.ico')])