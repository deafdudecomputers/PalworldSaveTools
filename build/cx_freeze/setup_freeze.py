...
def find_pyside6_assets():
    ...
    try:
        ...
        webengine_process = os.path.join(p, 'QtWebEngineProcess.exe')
        if os.path.exists(webengine_process):
            result.append((webengine_process, 'lib/PySide6/QtWebEngineProcess.exe'))
        resources_dir = os.path.join(p, 'resources')
        if os.path.exists(resources_dir):
            result.append((resources_dir, 'lib/PySide6/resources'))
